...
import ItemDetailsPolicies from '../components/ItemDetailsPolicies';
import ItemDetailsVehicles from '../components/ItemDetailsVehicles';
import ItemDetailsCriteria from '../components/ItemDetailsCriteria';
...
import {isSignedin, fetchListings, fetchSpecificListing, userInformation} from '../actions/UserAction';
...
const specificListings = useSelector((state: RootStore) => state.SpecificListing);
const [viewModal, setViewModal] = useState({isOpen: false})
const locationChecker = () => {
    return ((location?.pathname.includes("/ManageItem/Items/")) || (location?.pathname.includes("/ManageItem/Items"))) ?
    true :
    false;
};
const [loading, setLoading] = useState(true);
const [pageResponseValue, setPageResponseValue] = useState(true);
const [activeEdit, setActiveEdit] = useState("");
const [toggleEdit, setToggleEdit] = useState("itemDetails");
...
// const [editListing, setEditListing] = useState<any>({ 
//     category_value: "",
//     category: "",
//     sub_category: "",
//     brand: "",
...
const PageResponse = (res:any) => {
    if(res) {
        setPageResponseValue(true);
    } else {
        setPageResponseValue(false);
    }
};
...
useEffect(()=> {
  setEditListing(specificListings);
}, [specificListings]);
...
useEffect(()=>{
    console.log("this is the value of editlisting", editListing)
  }, [editListing]);
            ...
            !loading && pageResponseValue &&
                <>
                    ...
                    <IonContent class="home_content" fullscreen>
                        <div className="ItemDetails" style={{minHeight: `${GetViewPortSize()}`}}>
                          ...
                          <div className="listing_wrapper">
                            ...
                            <div className="inner_wrapper">
                              ...
                              <div className="window_box">
                                ...
                                <div className="row">
                                  {/* <div className="item_hero" style={{backgroundImage: `url("assets/img/bg/pexels-julio-nery-1687147.jpg")`}}> */}
                                  <div className="item_hero" style={{backgroundImage: `url('${ (specificListings?.ListingImage && specificListings?.ListingImage[0]) ? specificListings?.ListingImage[0]?.high_res : "" }')`}}>
                                  
                                  </div>
                                  <div className="hero_title">
                                    <span className="title_head">{specificListings?.title}</span>
                                    <span className="title_sub">{specificListings?.description}</span>
                                    <span className="title_sm">{specificListings?.address}</span>
                                  </div>

                                </div>

                                {
                                  (specificListings?.status === "initial_rejection" || specificListings?.status === "missing_compliance") &&
                                  <div className="row spacious">
                                    <div className="header_title">
                                      {
                                        specificListings?.status === "missing_compliance" &&
                                        <>
                                          MISSING COMPLIANCE
                                          <img className="warning_sign" src="assets/img/icons/warning.png" alt="" />
                                        </>
                                      }
                                      {
                                        specificListings?.status === "initial_rejection" &&
                                        <>
                                          REJECTED
                                          <img className="warning_sign" src="assets/img/icons/error.png" alt="" />
                                        </>
                                      }
                                ...
                                <div className="row box-shadow">
                                    ...
                                    <div className="badge_title">
                                        <img src="assets/Logo/edit details.png" alt="" />
                                    </div>

                                    <div className="pill_wrapper">
                                      <div onClick={()=>{setToggleEdit("itemDetails")}} className={`pill ${toggleEdit ==="itemDetails" ? "active_pill" : ""}`}>Item Details</div>
                                      <div onClick={()=>{setToggleEdit("policy")}} className={`pill ${toggleEdit ==="policy" ? "active_pill" : ""}`}>Policies</div>
                                      <div onClick={()=>{setToggleEdit("criteria")}} className={`pill ${toggleEdit ==="criteria" ? "active_pill" : ""}`}>Renter's Criteria</div>
                                    </div>


                                  {
                                    toggleEdit === "itemDetails" &&
                                      ...
                                      <div className="item_edit_container">
                                        ...
                                        <div className="edit_item_wrapper">
                                          ...
                                          <div className="edit_item_box">
                                            <div className="edit_title">Sub Category</div>
                                            <div className="edit_value">
                                              <span className="value_text">{specificListings?.sub_category?.replace('_', ' ')}</span>
                                              <div className="edit_box" onClick={()=>{ setActiveEdit("sub_category"); setViewModal({isOpen:true}); }}>
                                          ...
                                          <div className="edit_item_box">
                                            ...
                                            <div className="edit_value">
                                              <span className="value_text">{specificListings?.title}</span>
                                              <div className="edit_box" onClick={()=>{ setActiveEdit("title"); setViewModal({isOpen:true}); }}>
                                                <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                <span>Edit</span>
                                              </div>
                                            </div>
                                          ...
                                          <div className="edit_item_box">
                                            <div className="edit_title">Description</div>
                                            <div className="edit_value">
                                              <span className="value_text">{specificListings?.description}</span>
                                              <div className="edit_box" onClick={()=>{ setActiveEdit("description"); setViewModal({isOpen:true}); }}>
                                                <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                <span>Edit</span>
                                              </div>
                                            </div>
                                          ...
                                          {
                                            (editListing?.category == "home" || editListing?.category == "car") &&
                                            <div className="edit_item_box">
                                              <div className="edit_title">Amenities</div>
                                              <div className="edit_value">
                                                <div className="value_box">
                                                {
                                                  (specificListings?.listing_amenity !== undefined && specificListings?.listing_amenity.length>0) && specificListings?.listing_amenity.map((item: any, index: number) => {
                                                    return (
                                                      <>
                                                ...
                                                <div className="edit_box" onClick={()=>{ setActiveEdit("amenities"); setViewModal({isOpen:true}); }}>
                                                  <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                  <span>Edit</span>
                                                </div>
                                              </div>
                                          ...
                                          <div className="edit_item_box">
                                            <div className="edit_title">Photos</div>
                                            <div className="edit_value">
                                              <div className="value_box">
                                              {
                                                (specificListings?.ListingImage !== undefined && specificListings?.ListingImage.length>0) && specificListings?.ListingImage.map((item: any, index: number) => {
                                                  return (
                                                    <>
                                                      <img src={item?.low_res} alt="" className="images" />
                                                    </>
                                                  )
                                                })
                                              }
                                              </div>
                                              <div className="edit_box" onClick={()=>{ setActiveEdit("photos"); setViewModal({isOpen:true}); }}>
                                                <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                <span>Edit</span>
                                              </div>
                                            </div>
                                          ...
                                          <div className="edit_item_box">
                                            <div className="edit_title">Additional Information</div>
                                            <div className="edit_value">
                                              <span className="value_text">Edit to see your options</span>
                                              <div className="edit_box" onClick={()=>{setActiveEdit("add_info"); setViewModal({isOpen:true})}}>
                                                <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                <span>Edit</span>
                                              </div>
                                            </div>
                                          ...
                                          <div className="edit_item_box">
                                            <div className="edit_title">Address</div>
                                            <div className="edit_value">
                                              <span className="value_text">{specificListings?.address}, {specificListings?.city}, {specificListings?.country}</span>
                                              <div className="edit_box" onClick={()=>{ setActiveEdit("address"); setViewModal({isOpen:true}); }}>
                                                <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                <span>Edit</span>
                                              </div>
                                            </div>
                                          ...
                                          <div className="edit_item_box">
                                            <div className="edit_title">Pricing</div>
                                            <div className="edit_value">
                                              <span className="value_text">${specificListings?.price} / {specificListings?.rate_type} rate</span>
                                              <div className="edit_box" onClick={()=>{ setActiveEdit("price"); setViewModal({isOpen:true}); }}>
                                                <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                <span>Edit</span>
                                              </div>
                                            </div>
                                          ...
                                          <div className="edit_item_box">
                                            <div className="edit_title">Item Status</div>
                                            <div className="edit_value">
                                              <span className="value_text">{specificListings?.active_status}</span>
                                              <div className="edit_box" onClick={()=>{ setActiveEdit("active_status"); setViewModal({isOpen:true}); }}>
                                                <img className="edit_icon" src="assets/img/icons/edit.png" alt="" />
                                                <span>Edit</span>
                                              </div>
                                            </div>
                                        ...
                                        {
                                            editListing?.category === "car" &&
                                            <ItemDetailsVehicles
                                                item = {specificListings}
                    ...
                    <EditListingModal
                      ...
                      OnClose= { () => { setViewModal({isOpen: false}); setTimeout(()=>setActiveEdit(""), 200);  }}
                      activeEdit = {activeEdit}
                      editListing = {editListing}
                      setEditListing = {setEditListing}
                      listingDetails = {itemCategoriesList}
                      id = {id}
                    />
